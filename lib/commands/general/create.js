...
module.exports = new Clapp.Command({
	...
	fn: (argv, context) => {
		...
		return bot.CreateChannel(guild, channelName, time, null, context.msg.member.displayName)
			.then(response => {
	...
	args: [
		...
		},
		{
			...
			validations: [
				{
					errorMessage: `Invalid time input. Example \`!create roomname 70\` or \`!create roomname 1:10\`. Max time is ${cfg.create_channel_max_time} minutes.`,
