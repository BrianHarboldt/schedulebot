...
module.exports = new Clapp.Command({
	...
	fn: (argv, context) => {
		...
		if (room != null && room.channel != null) {
			console.log(`Channel rename requested for ${room.channel} updated to be ${room.channel.name} from requested name: ${channelName}. Request made by ${context.msg.author.username}.`);
