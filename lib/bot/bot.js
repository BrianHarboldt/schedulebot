...
module.exports = {
    ...
    CreateChannel: function(guild, channelName, time, coords, createdBy) {
        ...
        if (categoryChannel && categoryChannel.children && categoryChannel.children.array().length > 0) {
            rawChannel = categoryChannel.children.array()[0].clone(channelName, true); //TODO: This is a hack until 12.0 discord.js comes out and we get lockPermissions()
        } else {
    ...
    CheckSpecialChannel: function(channel, coords){
        ...
        } else if (channelName.includes("findshinydealsatsprint") || channelName.includes("sprint-lew") || coords == "33.005965,-96.973714") {
        ...
        } else if (channelName.includes("parkerssquare") || coords == "33.040559,-97.048274") {
            targetRole = "parkers-square";
        } else if (channelName.includes("forestvistafountain") || coords == "33.020201,-97.062426") {
            targetRole = "forest-vista-fountain";
        } else {
            return null;
        }
        ...
        console.log("Channel (" + channelName + ") trying to use targetrole: " + targetRole + ". Found role: " + role);
