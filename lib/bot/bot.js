...
let createdRooms = []; // [{msgs,channel,time,createdAt,expiresAt,warningTime,coords}]
let modRoles = [];
    ...
    BuildChannelParams: function(guild, embed) {
        ...
        try {
            ...
            if (channelName.length <= 0) {
                ...
                else channelName = '-' + embed.title.substring(0, 8) + '-' + parts[0];
            }
            if (channelName.indexOf('-', 1) < 0) channelName += '-' + coords;
