...
module.exports = {
    ...
    DeleteChannel: function(guild, channelName, msg) {
        ...
        {
            console.log(`Delete: tracked room not found for delete - ${channelName}`);
            return;
        }
        ...
        if (!channel)
        {
            console.log(`Delete: guild room not found for delete - ${channelName}`);
        ...
        channel.delete()
			.then(console.log(`Delete: deleted channel ${channel}`))
			.catch(console.error);
