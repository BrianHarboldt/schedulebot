...
module.exports = {
    ...
    CheckSpecialChannel: function(channel, coords){
        var locations = [
            {role: "gerault-park", trigger: {name: "gerault", coords: "33.000107,-97.045322", op: "OR"}},
            {role: "spring-meadow-park", trigger: {name: "springmeadow", coords: "33.037749,-97.054292", op: "OR"}},
            {role: "grove-park-fm", trigger: {name: "grovepark", coords: "33.038210,-97.038008", op: "OR"}},
            {role: "tealwood-oaks-park", trigger: {name: "tealwoodoaks", coords: "33.010933,-97.039777", op: "OR"}},
            {role: "staton-oak-park", trigger: {name: "statonoak", coords: "33.027369,-97.061694", op: "OR"}},
            {role: "grand-park", trigger: {name: "grandpark", coords: "33.069037,-97.059903", op: "OR"}},
            {role: "dixon-park", trigger: {name: "dixonpark", coords: "33.066734,-97.070472", op: "OR"}},
            {role: "possum-park", trigger: {name: "possumpark", coords: "33.025646,-97.067559", op: "OR"}},
            ...
            {role: "parkers-square", trigger: {name: "parkersquare", coords: "33.040559,-97.048274", op: "OR"}},
        ...
        if (role) {
            return {
                ...
                coords: location.trigger.coords
            };
        } else {
            return null;
        }
