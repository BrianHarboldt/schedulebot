...
module.exports = {
    ...
    PostChannel: function(createChannelResponse, targetChannel, coords) {
        ...
        this.NotifySpecialChannel(createChannelResponse, coords);
    ...
    NotifySpecialChannel: function(createChannelResponse, coords){
        var channelName = createChannelResponse.channel.name.toLowerCase();
        ...
        var role = createChannelResponse.channel.guild.roles.find(function(r) {
            return r.name.toLowerCase() == targetRole;
        });

        if (role) {
            createChannelResponse.channel.send(`${!certain ? "Possible match - ":" "}${role}`);
        }
    }
};
